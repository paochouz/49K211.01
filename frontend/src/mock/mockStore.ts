...
const costumes: Costume[] = [
  { maTP: 'TP000001', tenTP: 'Áo dài truyền thống', loaiTP: 'Áo dài', giaThue: 150000, size: 'M', moTa: 'Áo dài lụa cao cấp', hinhAnh: '', trangThai: 'Sẵn sàng' },
  { maTP: 'TP000002', tenTP: 'Vest nam lịch lãm', loaiTP: 'Vest', giaThue: 200000, size: 'L', moTa: 'Vest đen sang trọng', hinhAnh: '', trangThai: 'Đang thuê' },
  { maTP: 'TP000003', tenTP: 'Váy dạ hội đỏ', loaiTP: 'Váy dạ hội', giaThue: 300000, size: 'S', moTa: 'Váy dạ hội đỏ rực', hinhAnh: '', trangThai: 'Sẵn sàng' },
  { maTP: 'TP000004', tenTP: 'Hanbok Hàn Quốc', loaiTP: 'Cosplay', giaThue: 250000, size: 'M', moTa: 'Hanbok truyền thống', hinhAnh: '', trangThai: 'Hư hỏng' },
];
