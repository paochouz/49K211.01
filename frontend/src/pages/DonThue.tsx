...
const initialOrders: OrderItem[] = [
  {
    id: '1',
    invoiceNo: 'HDT000001',
    customer: 'Nguyễn Anh Khoa',
    item: 'Vest nam xanh navy',
    phone: '0912345678',
    rentedAt: '10/06/2026',
    dueDate: '12/06/2026',
    status: 'Chưa cọc đơn',
  ...
  },
  {
    id: '4',
    invoiceNo: 'HDT000004',
    customer: 'Phạm Ngọc Ánh',
    item: 'Vest nữ kem',
    phone: '0933222111',
    rentedAt: '02/06/2026',
    dueDate: '06/06/2026',
    returnedAt: '06/06/2026',
    status: 'Đã trả',
    deposit: '400.000đ',
    total: '850.000đ',
  },
...
export default function RentalOrdersPage() {
  ...
  const [filteredOrders, setFilteredOrders] = useState<OrderItem[]>(initialOrders);
