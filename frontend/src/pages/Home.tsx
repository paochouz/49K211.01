...
export default function Home() {
  ...
  const username = user.taiKhoan || "Bạn";
  const vaiTroRaw: string = (user.vaiTro || "").toLowerCase().replace(/\s/g, '');
  const isOwner = vaiTroRaw === "chucuahang" || vaiTroRaw === "chủcửahàng" || vaiTroRaw === "owner" || vaiTroRaw === "admin";
